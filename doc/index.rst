Sequana depletion pipeline documentation
#####################################################

|version|, |today|, status: production

The **depletion** pipeline is a `Sequana <https://github.com/sequana/sequana>`_ pipeline. You can find the source code 
on  `https://github.com/sequana/sequana_depletion <https://github.com/sequana/sequana_depletion/>`_. Would you have issues
...
The Sequana depletion pipeline
==============================================
